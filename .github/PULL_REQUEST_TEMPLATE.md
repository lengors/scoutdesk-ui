<!--
  Thank you for your contribution to the scoutdesk-ui project! We appreciate your efforts.
  ...
  3. **Testing**: Run `npm run test` to ensure all tests pass.
  4. **Code Style**: Check your code with [Prettier](https://prettier.io/) (`npm run prettier:check`) and [ESLint](https://eslint.org/) (`npm run lint`).
  ...
  For more details on contributing, please refer to our guide: https://github.com/lengors/scoutdesk-ui/blob/main/CONTRIBUTING.md
-->
